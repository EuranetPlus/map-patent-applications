export const config = {
	mapTitle: 'map-patent-aplications', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-patent-aplications.vercel.app', // The url provided when deploying the map on Vercel
